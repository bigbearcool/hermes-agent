...
# =========================================================================
# Fork detection for the `hermes update` source notice
# =========================================================================
...
def _cmd_update_check(branch: str = "main"):
    ...
    ``branch`` selects which ``origin`` branch the check compares against.
    Default is "main"; callers can pass another branch without performing
    the update. Official-upstream synchronization is intentionally outside
    this command so its status always matches what ``hermes update`` installs.
    """
    ...
    # Fetch only the origin branch we compare against. A bare `git fetch
    # origin` pulls every ref, and this repo has thousands of auto-generated
