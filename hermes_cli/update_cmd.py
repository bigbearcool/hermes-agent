...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    # Fetch only the origin branch the apply path can install. A bare
    # `git fetch origin` pulls every ref, and this repo has thousands of
    # auto-generated branches, so scope the fetch to <branch>.
