...
class TestGetServicePidsScoping:
    def _wire(self, monkeypatch):
        ...
        # ``all_profiles=True`` also performs a bare launchctl prefix scan as
        # a safety net for labels that cannot be derived from profile state.
        # Keep this unit test isolated from the host's real LaunchAgents.
        monkeypatch.setattr(
            gw.subprocess,
            "run",
